...
torch.save(X,"data/gfp/gfp_1hot_X.pt")
torch.save(y,"data/gfp/gfp_1hot_y.pt")
torch.save(X_train,"data/gfp/gfp_1hot_X_train.pt")
torch.save(y_train,"data/gfp/gfp_1hot_y_train.pt")
torch.save(X_test,"data/gfp/gfp_1hot_X_test.pt")
torch.save(y_test,"data/gfp/gfp_1hot_y_test.pt")
