...
# Save paths 
RANDOM_METRICS_PATH = PWD + "inference/gfp_random_metrics_" + NAME_OF_RUN + ".npy"
GFLOW_METRICS_PATH = PWD + "inference/gfp_gflow_metrics_" + NAME_OF_RUN + ".npy"
MCMC_METRICS_PATH = PWD + "inference/gfp_mcmc_metrics_" + NAME_OF_RUN + ".npy"
...
print("GFP Evaluation complete. Saved metrics.")